...
import flink.ocl.build.engine.kernel.builders.utility.DoubleVarDefinitionLine;
import flink.ocl.build.engine.kernel.builders.utility.IntVarDefinitionLine;
import flink.ocl.build.engine.kernel.builders.utility.StringVarDefinitionLine;
import flink.ocl.build.engine.tuple.variables.InputVarDefinition;
import flink.ocl.build.engine.tuple.variables.OutputVarDefinition;
